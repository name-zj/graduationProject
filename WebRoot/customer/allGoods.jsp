		...
		<tbody>
			<c:forEach items="${goods }" var="good">
				<tr>
					...
					<td>${good.gprice }</td>
					<td><a href="${pageContext.request.contextPath}/findGoodsById?id=${good.id }">查看详情</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
...
<script language="javascript">  
	function skip () {
		...
		if(e.keyCode==13){
			if(v!=""){
				window.location.href = "${pageContext.request.contextPath }/findAllGoods?curPage="+v
