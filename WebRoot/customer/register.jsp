				...
				<div class="form-group has-feedback">
					<div class="input-group">
						<span class="input-group-addon"> <span
							...
							name="userimg" placeholder="UserImg" autofocus>
					</div>
				</div>
				<div class="form-group has-feedback">
					<div class="input-group">
				...
				<div class="form-group has-feedback">
					<div class="input-group">
						<span class="input-group-addon"> <span
							...
							name="password2" placeholder="Password" autofocus>
					</div>
				</div>
				<div class="form-group has-feedback">
					<div class="input-group">
						<span class="input-group-addon"> <span
							...
							name="phone" placeholder="Phone" autofocus>
					</div>
				</div>
				<div class="form-group has-feedback">
					<input type="button" class="btn btn-success"  onclick="chase()" value="Register"></button>
				</div>
				<div class="form-group has-feedback">
